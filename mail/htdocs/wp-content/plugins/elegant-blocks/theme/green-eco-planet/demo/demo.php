...
function bizberg_import_files() {
  	return array(
  		array(
      		'import_file_name'             => esc_html__( 'Green Eco Planet Free', 'bizberg' ),
      		'categories'                   => array( 'Homepage' , 'Free' ),
	      	'import_preview_image_url'     => 'http://cyclonethemes.com/wp-content/uploads/2018/06/nature-free.jpg',
	      	'preview_url'                  => 'https://bizberg.cyclonethemes.com/nature-free/',
	    ...
	    array(
      		'import_file_name'             => esc_html__( 'Green Eco Planet PRO', 'bizberg' ),
  		...
  		array(
      		'import_file_name'             => esc_html__( 'Building Construction Architecture Free', 'bizberg' ),
	    ...
	    array(
      		...
      		'categories'                   => array( 'PRO','Homepage' ),
	      	'import_preview_image_url'     => 'https://cyclonethemes.com/wp-content/uploads/2018/06/wedding-free-pro.jpg',
...
function bizberg_custom_admin_css() { 
	...
	if( !empty( $_GET['page'] ) && $_GET['page'] == 'cyclone-one-click-demo-import' ){ ?>
		...
		<style>
			.js-ocdi-gl-item[data-name="building construction architecture free"] button,
	    	.js-ocdi-gl-item[data-name="green eco planet pro"] button,
	    	...
	    	.js-ocdi-gl-item[data-name="wedding pro"] button,
	    	.js-ocdi-gl-item[data-name="construction pro"] button,
