...
/**
 * Register NGO Charity Fundraising Theme Page
 */
...
function elegant_blocks_register_theme_page() {
    add_submenu_page(
        'themes.php',
        esc_attr__( 'Building Construction Architecture Options', 'elegant-blocks' ),
        esc_attr__( 'Building Construction Architecture Options', 'elegant-blocks' ),
        'manage_options',
        ...
        <div class="bizberg_header">
        	<div class="bizberg_container">
	        	<div class="bizberg_header_left">
	        		<img src="<?php echo esc_url( ELEGANTBLOCKS_PLUGIN_URL . '/src/images/bca.png' ); ?>">
        ...
        <div class="bizberg_container">
        	...
        	<div class="column_60">
	    		...
	    		<div class="customizer_settings pro">
		    		...
		    		<h3><?php esc_html_e( 'Elegant Blocks for NGO Charity Fundraising', 'elegant-blocks' ); ?></h3>
	    	...
	    	<div class="column_40">
	    		...
	    		<div class="customizer_settings import_site_wrapper">    		
		    		...
		    		<img src="<?php echo esc_url( ELEGANTBLOCKS_PLUGIN_URL . '/src/images/bca-hub-starter-sites.jpg' ); ?>">
		    	...
		    	<div class="customizer_settings support_wrapper">    		
		    		...
		    		<p>If you have any problem, visit our <a href="<?php echo esc_url( elegant_blocks_ngo_charity_fundraising_get_support_forum_link() ); ?>" target="_blank">support forum</a>.</p>		    		
		    	</div>
		    	...
		    	<div class="customizer_settings review_wrapper">    		
		    		...
		    		<p>If you like the theme please give us a 5 star rating. <a href="https://wordpress.org/support/theme/building-construction-architecture/reviews/?rate=5#new-post" target="_blank">Click here</a> to show your love.</p>
		    	</div>
...
function elegant_blocks_ngo_charity_fundraising_get_support_forum_link(){
	return 'https://cyclonethemes.com/forums/forum/free-version/building-construction-architecture-lite/';
}
