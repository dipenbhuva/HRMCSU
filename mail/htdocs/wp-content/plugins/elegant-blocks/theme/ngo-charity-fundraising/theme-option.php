...
function elegant_blocks_register_theme_page() {
    add_submenu_page(
        'themes.php',
        esc_attr__( 'NGO Charity Fundraising Options', 'elegant-blocks' ),
        esc_attr__( 'NGO Charity Fundraising Options', 'elegant-blocks' ),
        'manage_options',
        ...
        <div class="bizberg_header">
        	<div class="bizberg_container">
	        	<div class="bizberg_header_left">
	        		<img src="<?php echo esc_url( ELEGANTBLOCKS_PLUGIN_URL . '/src/images/ngo.png' ); ?>">
        ...
        <div class="bizberg_container">
	    	...
	    	<div class="column_40">
	    		...
	    		<div class="customizer_settings import_site_wrapper">    		
		    		...
		    		<img src="<?php echo esc_url( ELEGANTBLOCKS_PLUGIN_URL . '/src/images/ngo-starter-sites.jpg' ); ?>">
		    	...
		    	<div class="customizer_settings review_wrapper">    		
		    		...
		    		<p>If you like the theme please give us a 5 star rating. <a href="https://wordpress.org/support/theme/ngo-charity-fundraising/reviews/?rate=5#new-post" target="_blank">Click here</a> to show your love.</p>
		    	</div>
...
function elegant_blocks_ngo_charity_fundraising_get_support_forum_link(){
	return 'https://cyclonethemes.com/forums/forum/free-version/ngo-charity-fundraising-lite/';
}
