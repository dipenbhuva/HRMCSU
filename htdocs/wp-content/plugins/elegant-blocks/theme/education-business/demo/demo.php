...
function bizberg_import_files() {
  	return array(
  		array(
      		'import_file_name'             => esc_html__( 'Education Free', 'bizberg' ),
      		'categories'                   => array( 'Homepage' , 'Free' ),
	      	'import_preview_image_url'     => 'http://cyclonethemes.com/wp-content/uploads/2018/06/education-free.jpg',
	      	'preview_url'                  => 'https://bizberg.cyclonethemes.com/education-free/',
