...
function bizberg_import_files() {
  	return array(
  		array(
      		'import_file_name'             => esc_html__( 'NGO Charity Fundraising Free', 'bizberg' ),
		    ...
		    'local_import_widget_file'     => trailingslashit( plugin_dir_path( __FILE__ ) ) . 'widgets.wie',
	      	'import_preview_image_url'     => 'http://cyclonethemes.com/wp-content/uploads/2018/06/charity-free.jpg',
	      	'preview_url'                  => 'https://bizberg.cyclonethemes.com/charity-free/',
	    ),
	    array(
