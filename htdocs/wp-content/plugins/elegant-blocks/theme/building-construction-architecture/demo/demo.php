  	...
  	return array(
  		array(
		    ...
		    'local_import_widget_file'     => trailingslashit( plugin_dir_path( __FILE__ ) ) . 'widgets.wie',
	      	'import_preview_image_url'     => 'http://cyclonethemes.com/wp-content/uploads/2018/06/construction-free.jpg',
	      	'preview_url'                  => 'https://bizberg.cyclonethemes.com/construction-free/',
	    ),
	    array(
